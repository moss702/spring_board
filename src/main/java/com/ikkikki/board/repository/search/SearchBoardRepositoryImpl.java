...
import com.ikkikki.board.domain.entity.QBoard;
import com.ikkikki.board.domain.entity.QMember;
import com.ikkikki.board.domain.entity.QReply;
...
public class SearchBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchBoardRepository {
  ...
  public Board search1() {
    ...
    // member 조인 : QMember는 어차피 스테틱이라서, 변수 만드는게 필수는 아님. 그냥 호출해도 괜찮.
    jpqlQuery
